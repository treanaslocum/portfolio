    ...
    <section class="mt-24">
      <div class="flex sm:flex-row flex-col  m-16">
        <div class="sm:w-2/4 w-full mr-16">
          <img class="mb-8" src="~/assets/images/hyperion.jpg">
          <img class="mb-8" src="~/assets/images/hyperion-search_results.png">
          <img class="mb-8" src="~/assets/images/home-listing.jpg">
        </div>
        <div class="sm:w-2/4 w-full">
          <h1 class="mb-8 text-5xl font-medium">Hyperion Real Estate <br><span class="text-xl font-light">UI/UX Design</span></h1>
